...
// // ── Change this to your PythonAnywhere backend URL before deploying ──
...
//             TaskFlow
//           </div>
//           {total > 0 && <span className="badge">{completed}/{total} done</span>}
//         </div>
//       </header>
...
//                 <div className="progress-bar" style={{ width: `${total ? (completed/total)*100 : 0}%` }}/>
//               </div>
//             )}
//           </div>
...
//               <div className="skeleton"/><div className="skeleton" style={{width:"75%"}}/><div className="skeleton" style={{width:"55%"}}/>
//             </div>
//           ) : tasks.length === 0 ? (
...
//               {tasks.map((task) => (
//                 <li key={task.id} className={`task-item ${task.is_completed ? "done" : ""}`}>
//                   <span className={`status-dot ${task.is_completed ? "dot-done" : "dot-pending"}`}/>
